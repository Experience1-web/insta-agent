...
echo   einer Behoerde wie der NASA. Kostet nichts.
echo.
...
echo   USGS. Nachrichtenseiten gehen nicht - deren Bilder gehoeren Agenturen.
echo.
echo   Tipp: Die Adresse steht im Dashboard beim Fund unter "Quellen".
echo.
set /p ADRESSE=Adresse der Seite einfuegen (Rechtsklick fuegt ein): 
echo.
